...
class PrintPreNumberedChecks(models.TransientModel):
    ...
    next_number = fields.Integer(
        "Next Check Number",
        compute="get_next_cheque_number")
...
#     browse(self.env.context['payment_ids'])
    #         if payments:
...
#     payment.journal_id.account_checkbook_id.printed_page =
#             payment.journal_id.account_checkbook_id.start_page
    # else:
#     payment.journal_id.account_checkbook_id.printed_page =
#         payment.journal_id.account_checkbook_id.printed_page + 1
    #     return res
